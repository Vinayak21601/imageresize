        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                <div className="space-y-2 text-center">
                  ...
                  <span className={`text-xs font-medium ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
                    1. Lock Proportional Aspect Ratio
                  </span>
                </div>
                <div className="space-y-2 text-center">
                  <img
                  ...
                  />
                  <span className={`text-xs font-medium ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
                    2. Crop Target Shape Before Resizing
                  </span>
                </div>
                <div className="space-y-2 text-center">
                  <img
                  ...
                  />
                  <span className={`text-xs font-medium ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
                    3. Use WebP / AVIF Modern Formats
                  </span>
                </div>
              </div>
              ...
              >
                <p>
                  We&rsquo;ve all been there. You have a perfectly good photo, but the website says{' '}
                  <strong className={isDark ? 'text-white' : 'text-slate-900'}>&ldquo;Image dimensions not supported.&rdquo;</strong> You resize it, upload it again, and suddenly the photo looks blurry. Or maybe you&rsquo;ve reduced the file size and now the image looks nothing like the original.
                </p>
                <p>
                  So, what went wrong?
                </p>
                <p>
                  ...
                  isn&rsquo;t simply about making it smaller or bigger. The way you resize an image matters. If you maintain the right proportions, choose suitable dimensions, and use the right format, you can resize an image while keeping it looking sharp and natural.
                </p>
                <p>
                  In this guide, we&rsquo;ll walk through how to resize an image without losing quality, explain the difference between resizing and{' '}
                  <Link href="/" target="_blank" rel="noopener noreferrer" className={inlineLinkCls}>
                    cropping
                  </Link>{' '}
                  (including custom contours with our{' '}
                  ...
                  ), and show you what to consider when preparing images for websites, social media, applications, documents, and more.
                </p>
              </div>

              {/* SECTION 1 */}
              <section
                id="what-does-resizing-mean"
              ...
              >
                ...
                <p className="font-mono text-[#1E50F2] dark:text-sky-400 font-bold text-lg">
                ...
                <ul className={`list-disc pl-6 space-y-1.5 font-medium ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>
                  <li><strong className={isDark ? 'text-white' : 'text-slate-900'}>4032 &times; 3024 px</strong> &rarr; image dimensions</li>
                  <li><strong className={isDark ? 'text-white' : 'text-slate-900'}>4 MB</strong> &rarr; file size</li>
                  <li><strong className={isDark ? 'text-white' : 'text-slate-900'}>JPG</strong> &rarr; file format</li>
                </ul>
                <p>
              ...
              {/* SECTION 2 */}
              <section
                id="why-does-an-image-become-blurry"
                className={`space-y-4 scroll-mt-28 border-t pt-8 transition-colors duration-300 ${
                  isDark ? 'border-white/10' : 'border-slate-100'
                }`}
              >
                ...
                <div className="space-y-4 pt-1">
                  ...
                  <div className="space-y-1">
                    <h3 className={`font-bold text-base ${isDark ? 'text-white' : 'text-slate-900'}`}>
                      You changed the image&rsquo;s proportions
                    </h3>
                    <p>
              ...
              {/* SECTION 3 */}
              <section
                id="how-to-resize-without-losing-quality"
                className={`space-y-4 scroll-mt-28 border-t pt-8 transition-colors duration-300 ${
                  isDark ? 'border-white/10' : 'border-slate-100'
                }`}
              >
                ...
                <div className="space-y-4 pt-1">
                  ...
                  <div className="space-y-1">
                    <h3 className={`font-bold text-base ${isDark ? 'text-white' : 'text-slate-900'}`}>
                      2. Know Where You&rsquo;re Going to Use the Image
                    </h3>
                    <p>
              ...
              >
                ...
                <p>
                  <strong className={isDark ? 'text-white' : 'text-slate-900'}>Resizing changes the dimensions.</strong> For example: 4000 &times; 3000 &rarr; 2000 &times; 1500. The entire image is still there. It&rsquo;s simply smaller.
                </p>

                <p>
                  <strong className={isDark ? 'text-white' : 'text-slate-900'}>Cropping removes part of the image.</strong> Imagine you&rsquo;ve taken a landscape photo, but you need a wide 16:9 banner. Instead of stretching the image, you can crop away some of the top or bottom, then resize the remaining image (e.g. Original photo &rarr; Crop to 16:9 &rarr; Resize to 1920 &times; 1080). This usually gives you a much more natural result.
                </p>

                <div className="py-2">
                  <p className="font-semibold text-[#1E50F2] dark:text-sky-400">The Simple Image-Resizing Workflow:</p>
                  <p className={`font-mono ${isDark ? 'text-slate-200' : 'text-slate-800'}`}>
                    Step 1: Crop &rarr; Step 2: Resize &rarr; Step 3: Choose format &rarr; Step 4: Check file size
                  </p>
                  <p className={`text-xs pt-1 ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
                    In simple terms: <strong>Crop &rarr; Resize &rarr; Format &rarr; Optimize</strong>.
                  </p>
                </div>
              </section>
              ...
              >
                ...
                <h3 className={`text-base sm:text-lg font-bold pt-1 ${isDark ? 'text-white' : 'text-slate-900'}`}>
              ...
              >
                ...
                <ul className={`list-disc pl-6 space-y-2 font-medium ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>
                  <li>
                    ...
                    Popular choice for photographs (travel, product, blog photos). Keeps file sizes small while maintaining good visual quality.
                  </li>
                  <li>
                    <strong className={isDark ? 'text-white' : 'text-slate-900'}>
                    ...
                    Useful when you need transparency, lossless image compression, logos, graphics, and screenshots.
                  </li>
                  <li>
                    <strong className={isDark ? 'text-white' : 'text-slate-900'}>
                    ...
                    Modern image format designed to provide good image quality with efficient file sizes for websites.
                  </li>
                  <li><strong className={isDark ? 'text-white' : 'text-slate-900'}>AVIF:</strong> Next-generation image format focused on efficient compression.</li>
                </ul>
                <p className="pt-2">
                  You can convert between all these formats effortlessly using our{' '}
                  <Link href="/convert" target="_blank" rel="noopener noreferrer" className="text-[#1E50F2] dark:text-sky-400 font-semibold hover:underline">
              ...
              >
                ...
                <p>
                  If you&rsquo;re trying to reduce a photo from several megabytes to a much smaller file, don&rsquo;t immediately reduce the quality slider to the lowest setting. Instead, look at the whole image. Ask: <em>Does the image actually need to be this large?</em> If not, reduce the dimensions first, or check out our guides on{' '}
                  <Link href="/blog/compress-image" target="_blank" rel="noopener noreferrer" className={inlineLinkCls}>
                    how to compress images online
                  </Link>{' '}
                  and{' '}
                  <Link href="/blog/how-to-resize-image-to-50kb" target="_blank" rel="noopener noreferrer" className={inlineLinkCls}>
                    how to resize images to 50KB
                  </Link>
                  . For example: 4032 &times; 3024 px might be unnecessarily large for a particular website placement. Creating a properly sized version can reduce the amount of data in the image while keeping it visually sharp.
                </p>
              ...
              >
                ...
                <p>
                  If all you need is a quick image resize, you shouldn&rsquo;t have to open complicated photo-editing software. With{' '}
                  <Link href="/" target="_blank" rel="noopener noreferrer" className={inlineLinkCls}>
                    CropMyImages
                  </Link>
                  , you can resize your image through a straightforward workflow:
                </p>

                <ol className={`list-decimal pl-6 space-y-2 font-medium ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>
                  <li><strong className={isDark ? 'text-white' : 'text-slate-900'}>Select your image:</strong> Upload the image you want to work with (JPG, PNG, WebP, AVIF).</li>
                  <li><strong className={isDark ? 'text-white' : 'text-slate-900'}>Set your required size:</strong> Enter the dimensions you need in px, inches, cm, or mm.</li>
                  <li><strong className={isDark ? 'text-white' : 'text-slate-900'}>Resize and export:</strong> Apply your settings and create the resized image.</li>
                </ol>

                <h3 className={`text-base sm:text-lg font-bold pt-2 ${isDark ? 'text-white' : 'text-slate-900'}`}>
                  How to Resize an Image to 1920 &times; 1080 Without Distortion
                </h3>
                <p>
              ...
              >
                ...
                <ol className={`list-decimal pl-6 space-y-2 font-medium ${isDark ? 'text-slate-200' : 'text-slate-800'}`}>
