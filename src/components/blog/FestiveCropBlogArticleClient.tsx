...
export function FestiveCropBlogArticleClient({ faqItems }: FestiveCropBlogArticleClientProps) {
  ...
  return (
    <div className="relative w-full min-h-screen bg-[#F8FAFC] text-slate-900 font-sans selection:bg-slate-900 selection:text-white flex flex-col">
        ...
        <header className="bg-sky-cloud-hero border-b border-zinc-200/60 pb-12 sm:pb-16 pt-4">
          ...
          <div className="max-w-4xl mx-auto space-y-6 text-center pt-8 px-4 sm:px-6 lg:px-8">
            ...
            <nav aria-label="Breadcrumb" className="flex items-center justify-center gap-2 text-xs font-semibold text-slate-600">
              ...
              <ChevronRight className="w-3.5 h-3.5 text-[#1E50F2] shrink-0" />
              <span className="text-[#1E50F2] truncate max-w-[200px] sm:max-w-none">Crop Festive Images</span>
            </nav>
            ...
            >
              How to Crop Festive Images Without Losing Quality <span className="font-serif italic font-normal text-slate-800 text-2xl sm:text-3xl block mt-2">(Janmashtami &amp; Teachers&apos; Day Special)</span>
            </h1>

            {/* AUTHOR & DATE METADATA ROW */}
            <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-slate-600 font-medium pt-2 border-t border-slate-200/80 max-w-md mx-auto">
              <div className="flex items-center gap-1.5" itemProp="author" itemScope itemType="https://schema.org/Organization">
                <User className="w-4 h-4 text-[#1E50F2]" />
                <span itemProp="name">CropMyImages Team</span>
              </div>
              <div className="flex items-center gap-1.5">
                <Calendar className="w-4 h-4 text-[#1E50F2]" />
                <time itemProp="datePublished" dateTime="2026-09-04">September 4, 2026</time>
              </div>
              <div className="flex items-center gap-1.5">
                <Clock className="w-4 h-4 text-[#1E50F2]" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <aside className="lg:col-span-4 sticky top-28 hidden lg:block space-y-6">
              <div className="bg-white border border-slate-200/80 rounded-3xl p-6 shadow-sm space-y-4">
                <div className="flex items-center gap-2 font-bold text-slate-900 text-sm border-b border-slate-100 pb-3 font-sans">
            ...
            <div className="lg:col-span-8 bg-white border border-slate-200/80 rounded-3xl p-6 sm:p-10 shadow-sm space-y-10 font-sans text-slate-800 text-base leading-relaxed">
              ...
              <section id="why-images-lose-quality" className="space-y-4 border-t border-slate-100 pt-8 scroll-mt-28">
                <h2 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight flex items-center gap-2.5 font-sans">
                  <BookOpen className="w-6 h-6 text-[#1E50F2] shrink-0" />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                  <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2">
                    <div className="text-xs font-bold text-[#1E50F2] uppercase tracking-wider">Factor 1</div>
                  ...
                  <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2">
                    <div className="text-xs font-bold text-[#1E50F2] uppercase tracking-wider">Factor 2</div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2">
                    <div className="flex items-center gap-3">
                      <span className="w-7 h-7 rounded-full bg-[#1E50F2] text-white font-black text-xs flex items-center justify-center">1</span>
                  ...
                  <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2">
                    <div className="flex items-center gap-3">
                      <span className="w-7 h-7 rounded-full bg-[#1E50F2] text-white font-black text-xs flex items-center justify-center">2</span>
                  ...
                  <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2">
                    <div className="flex items-center gap-3">
                      <span className="w-7 h-7 rounded-full bg-[#1E50F2] text-white font-black text-xs flex items-center justify-center">3</span>
              ...
              <section id="faqs-section" className="space-y-6 border-t border-slate-100 pt-8 scroll-mt-28">
                <h2 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight flex items-center gap-2.5 font-sans">
                  <HelpCircle className="w-6 h-6 text-[#1E50F2] shrink-0" />
                  ...
                  {faqItems.map((faq, idx) => (
                    <div key={idx} className="p-5 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2">
                      <h3 className="text-base font-bold text-slate-900 flex items-start gap-2">
                        <span className="text-[#1E50F2] font-mono">Q.</span>
                        <span>{faq.q}</span>
                      </h3>
